...
ssh quoc@172.20.36.146 sudo tcpdump -i eth0 -s 42 -w /home/quoc/Test/05_automation_tool/01_performance_QUIC_QUIC/result_server.pcapng&
...
google-chrome --incognito --user-data-dir=/tmp/quic --new-window --no-proxy-server --enable-quic --origin-to-force-quic-on=mydomain.com:443 --host-resolver-rules='MAP mydomaint.com:443 172.20.36.146:6131' https://mydomain.com/test/Thailan.jpg&
...
ssh quoc@172.20.36.146 sh /home/quoc/Test/05_automation_tool/01_performance_QUIC_QUIC/tcpdump_close.sh 
