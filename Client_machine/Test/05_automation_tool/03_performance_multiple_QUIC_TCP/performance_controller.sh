...
ssh quoc@172.20.36.146 sh /home/quoc/Test/05_automation_tool/03_performance_multiple_QUIC_TCP/server_performance.sh&

# Run client script: tcpdump both side, request streaming data, get result
sh /home/quoc/Test/05_automation_tool/03_performance_multiple_QUIC_TCP/client_performance.sh
...
# mkdir result_server
scp quoc@172.20.36.146:/home/quoc/Test/05_automation_tool/03_performance_multiple_QUIC_TCP/result_server.pcapng /home/quoc/Test/05_automation_tool/03_performance_multiple_QUIC_TCP/result_server
...
tshark -r result_server/result_server.pcapng  -qz io,stat,1,tcp.port==443,tcp.port==445,udp.port==6121,udp.port==6131 > result_server/log_server.txt

# process result at client side
tshark -r result_client/result_client.pcapng  -qz io,stat,1,tcp.port==443,tcp.port==445,udp.port==6121,udp.port==6131 > result_client/log_client.txt
