/*
 ============================================================================
 Name        : convert_range_ack.c
 Author      : Bao Quoc NGUYEN
 Version     :
 Copyright   : Your copyright notice
 Description : convert_range_acke in C, Ansi-style
 ============================================================================
 */
				       ...
				       while(1)
				          {
				    	   	  if(fgets(buff, 255, fp) ==NULL)
						          ...
						          if (buff[11] == '<' && buff[12] == '-' && buff[31] == 'L' && buff[32] == 'a' && buff[110] != '(' && buff[111] != 'n')
						          {
				            	      /// Get the numbers
				            	      float timestamp;
									  int pktnum;
				            	      ...
				            	      int i = 1;
				        			  if (pktnum == 887)
							        	  printf("PKT_num  %d sending time %f timestamp %f \n",pktnum,Send_t[i],timestamp);
